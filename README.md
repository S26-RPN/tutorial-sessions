...
This repository contains material for the tutorial sessions conducted during the course. Each session includes one or more Jupyter notebooks covering core concepts, along with an accompanying exercise notebook for practice.
...
* Please ensure the required Python environment is set up as specified in **Assignment A0** before running the notebooks.
* Exercise notebooks are for independent practice and **does not count towards the grading**
